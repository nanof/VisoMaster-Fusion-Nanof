...
SWAPPER_LAYOUT_DATA: Any = {  # noqa: F811
    "Swapper": {
        ...
        "SecondarySwapperEnableToggle": {
            ...
            "default": False,
            "help": "Run a second swapper model sequentially and blend the results. Off by default; no extra inference when disabled.",
        },
        "SecondarySwapModelSelection": {
            ...
            "requiredToggleValue": True,
            "help": "Secondary swapper to blend with the primary. Restricted to models that share the Inswapper128ArcFace latent space.",
        },
        "SecondarySwapperResSelection": {
            ...
            "parentToggle": "SecondarySwapperEnableToggle",
            "requiredToggleValue": True,
            "help": "Rendering resolution for the secondary swapper model.",
        },
