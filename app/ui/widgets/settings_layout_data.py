...
SETTINGS_LAYOUT_DATA: Any = {  # noqa: F811
    ...
    "General": {
        ...
        "MultiGpuModeSelection": {
            "level": 1,
            "label": "Multi-GPU mode",
            "options": [
                "Off",
                "Stage offload",
                "Frame routing (legacy)",
            ],
            "default": "Off",
            "help": "Off: single GPU (primary only). Stage offload (recommended): swap/detection stay on the primary GPU; optional face restorer and frame enhancer run on a secondary GPU. Frame routing (legacy): assigns whole frames across GPUs — not recommended when GPUs differ greatly in speed (e.g. 5070 Ti + 3060).",
            "exec_function": gpu_settings_actions.on_multi_gpu_mode_changed,
            "exec_function_args": [],
        },
        "MultiGpuSecondaryGpuSelection": {
            "level": 2,
            "label": "Secondary GPU (stage offload)",
            "default": 1,
            "parentSelection": "MultiGpuModeSelection",
            "requiredSelectionValue": "Stage offload",
            "help": "CUDA device used for offloaded face restorer and/or frame enhancer stages. Must differ from the primary GPU.",
        },
        "MultiGpuOffloadFaceRestorerToggle": {
            "level": 2,
            "label": "Offload face restorer to secondary GPU",
            "default": False,
            "parentSelection": "MultiGpuModeSelection",
            "requiredSelectionValue": "Stage offload",
            "help": "Runs restoration 1/2 on the secondary GPU while swap stays on the primary. Best when restorers are enabled and heavy.",
            "exec_function": gpu_settings_actions.on_stage_offload_toggle,
            "exec_function_args": [],
        },
        "MultiGpuOffloadFrameEnhancerToggle": {
            "level": 2,
            "label": "Offload frame enhancer to secondary GPU",
            "default": False,
            "parentSelection": "MultiGpuModeSelection",
            "requiredSelectionValue": "Stage offload",
            "help": "Runs the full-frame enhancer on the secondary GPU after swap. High resolutions may not benefit due to PCIe transfer cost.",
            "exec_function": gpu_settings_actions.on_stage_offload_toggle,
            "exec_function_args": [],
        },
        ...
        "GpuRoutingTargetsPicker": {
            ...
            "parentSelection": "MultiGpuModeSelection",
            "requiredSelectionValue": "Frame routing (legacy)",
        },
