...
#if QT_CONFIG(tooltip)
        self.buttonBatchAv1ToH264.setToolTip(QCoreApplication.translate("MainWindow", u"Find AV1 videos in the target folder and batch-convert them to H.264 (replaces each original file after a successful transcode).", None))
#endif // QT_CONFIG(tooltip)
        self.buttonBatchAv1ToH264.setText(QCoreApplication.translate("MainWindow", u"AV1→H.264", None))
