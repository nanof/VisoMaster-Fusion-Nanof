...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy10.setHeightForWidth(self.buttonBatchAv1ToH264.sizePolicy().hasHeightForWidth())
        self.buttonBatchAv1ToH264.setSizePolicy(sizePolicy10)
        ...
        sizePolicy2.setHeightForWidth(self.targetMediaSortComboBox.sizePolicy().hasHeightForWidth())
        self.targetMediaSortComboBox.setSizePolicy(sizePolicy2)
        self.targetMediaSortComboBox.setMinimumSize(QSize(96, 0))
        self.horizontalLayout_9.addWidget(self.targetMediaSortComboBox)
        self.targetMediaSortDirectionButton = QToolButton(self.dockWidgetContents)
        self.targetMediaSortDirectionButton.setObjectName(u"targetMediaSortDirectionButton")
        self.targetMediaSortDirectionButton.setCheckable(True)
        self.horizontalLayout_9.addWidget(self.targetMediaSortDirectionButton)
        self.targetVideosSearchResetButton = QToolButton(self.dockWidgetContents)
        self.targetVideosSearchResetButton.setObjectName(u"targetVideosSearchResetButton")
        self.horizontalLayout_9.addWidget(self.targetVideosSearchResetButton)
        self.targetMediaMinWidthSpinBox = QSpinBox(self.dockWidgetContents)
        self.targetMediaMinWidthSpinBox.setObjectName(u"targetMediaMinWidthSpinBox")
        sizePolicy2.setHeightForWidth(self.targetMediaMinWidthSpinBox.sizePolicy().hasHeightForWidth())
        self.targetMediaMinWidthSpinBox.setSizePolicy(sizePolicy2)
        self.targetMediaMinWidthSpinBox.setMinimumSize(QSize(70, 0))
        self.targetMediaMinWidthSpinBox.setMaximum(8192)
        self.horizontalLayout_9.addWidget(self.targetMediaMinWidthSpinBox)
        self.targetMediaMinHeightSpinBox = QSpinBox(self.dockWidgetContents)
        self.targetMediaMinHeightSpinBox.setObjectName(u"targetMediaMinHeightSpinBox")
        sizePolicy2.setHeightForWidth(self.targetMediaMinHeightSpinBox.sizePolicy().hasHeightForWidth())
        self.targetMediaMinHeightSpinBox.setSizePolicy(sizePolicy2)
        self.targetMediaMinHeightSpinBox.setMinimumSize(QSize(70, 0))
        self.targetMediaMinHeightSpinBox.setMaximum(8192)
        self.horizontalLayout_9.addWidget(self.targetMediaMinHeightSpinBox)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.zoomLabel.setText(QCoreApplication.translate("MainWindow", u"Zoom - x1.0", None))
#if QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.targetMediaSortComboBox.setToolTip(QCoreApplication.translate("MainWindow", u"Sort target media by name, date, size, dimensions, pixels or frame length", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.targetMediaSortDirectionButton.setToolTip(QCoreApplication.translate("MainWindow", u"Sort ascending", None))
#endif // QT_CONFIG(tooltip)
        self.targetMediaSortDirectionButton.setText(QCoreApplication.translate("MainWindow", u"\u2191", None))
#if QT_CONFIG(tooltip)
        self.targetVideosSearchResetButton.setToolTip(QCoreApplication.translate("MainWindow", u"Clear search", None))
#endif // QT_CONFIG(tooltip)
        self.targetVideosSearchResetButton.setText(QCoreApplication.translate("MainWindow", u"\u00d7", None))
#if QT_CONFIG(tooltip)
        self.targetMediaMinWidthSpinBox.setToolTip(QCoreApplication.translate("MainWindow", u"Minimum media width (0 = no filter)", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.targetMediaMinHeightSpinBox.setToolTip(QCoreApplication.translate("MainWindow", u"Minimum media height (0 = no filter)", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
