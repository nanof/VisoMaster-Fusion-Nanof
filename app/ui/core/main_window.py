...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.inputFacesTabWidget = QTabWidget(self.dockWidgetContents_Faces)
        self.inputFacesTabWidget.setObjectName(u"inputFacesTabWidget")
        self.input_faces_library_tab = QWidget()
        self.input_faces_library_tab.setObjectName(u"input_faces_library_tab")
        self.vboxLayout_InputFacesLibrary = QVBoxLayout(self.input_faces_library_tab)
        self.vboxLayout_InputFacesLibrary.setObjectName(u"vboxLayout_InputFacesLibrary")
        self.groupBox_InputFaces_Select = QGroupBox(self.input_faces_library_tab)
        ...
        self.vboxLayout_InputFacesFavorites = QVBoxLayout(self.input_faces_favorites_tab)
...
#if QT_CONFIG(tooltip)
        self.buttonBatchAv1ToH264.setToolTip(QCoreApplication.translate("MainWindow", u"Find videos in the target folder that are not H.264 (AV1, HEVC, VP9, etc.) and batch-convert them to H.264 (replaces each original file after a successful transcode).", None))
#endif // QT_CONFIG(tooltip)
