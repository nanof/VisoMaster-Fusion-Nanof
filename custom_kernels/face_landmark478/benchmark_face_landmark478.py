...
def bench():
    ...
    from custom_kernels.face_landmark478.face_landmark478_torch import FaceLandmark478Torch
    m_fp32 = (FaceLandmark478Torch.from_onnx(ONNX_PATH, compute_dtype=torch.float32)
              .cuda().eval())
    with torch.no_grad():
    ...
    m_fp16 = (FaceLandmark478Torch.from_onnx(ONNX_PATH, compute_dtype=torch.float16)
              .cuda().eval())
    with torch.no_grad():
    ...
    from custom_kernels.face_landmark478.face_landmark478_torch import build_cuda_graph_runner
